...
## Vertical axix is zero
## Horizontal axix is 1 

temp = conv1(imns, Hor, axis=1)
gflt_imns = conv1(temp, Ver, axis=0)


temp1 = conv1(imng, Ver, axis=0)
gflt_imng = conv1(temp1, Hor, axis=1)
